  ...
  projects = [
    {
      ...
      difficulty: 'easy',
      techStack: [
        { skill: 'HTML', imageUrl: 'HTML_Logo_pixel' },
        { skill: 'JS', imageUrl: 'JavaScript_LogoPixel' },
        { skill: 'CSS', imageUrl: 'CSS_Logo_pixel' },
      ],
      shortInformation:
    ...
    },
    {
      ...
      shortInformation:
        'A simple task management app that helps users organize, track, and manage their daily activities efficiently.',
      detailedInformation:
        'The To-Do List App is a straightforward productivity tool designed to help users organize their daily tasks with ease. It allows users to add, edit, complete, and delete tasks in a clean and intuitive interface. Task status is visually indicated, making it simple to track progress throughout the day. The app may also support categories, filtering between completed and active tasks, and saving tasks locally to ensure they remain available even after page refresh. The goal is to provide a minimal yet effective task management experience that helps users stay organized and productive.',
      linkUrl: '',
    },
    {
      imgUrl: '',
